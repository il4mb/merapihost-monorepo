...
import { AutoAwesome as AutoAwesomeIcon, Devices as DevicesIcon, DragIndicator as DragIndicatorIcon, Build as BuildIcon } from "@mui/icons-material";
...
const features = [
    { icon: <DragIndicatorIcon fontSize="small" />, label: "Drag & Drop Builder" },
    { icon: <AutoAwesomeIcon fontSize="small" />, label: "AI Assistant" },
    { icon: <BuildIcon fontSize="small" />, label: "Customizable Templates" },
    { icon: <DevicesIcon fontSize="small" />, label: "Responsive Design" },
];
...
export default function SignInPage({ }: PageProps) {
    ...
    const handleLogin = useCallback(async () => {
        ...
        try {
            ...
            enqueueSnackbar("Failed to login. Please try again.", { variant: "error" });
        } finally {
                        ...
                        <Stack spacing={4} sx={{ mb: { xs: 0, md: 12 } }}>
                            ...
                            <Box>
                                ...
                                <Typography variant="h3" component="h1" sx={{ fontWeight: 800, lineHeight: 1.2, color: "text.primary" }}>
                                    powered by AI for your business growth.
                                </Typography>
                            </Box>

                            {/* Description */}
                            <Typography variant="body1" sx={{ maxWidth: "90%", lineHeight: 1.8, color: "text.secondary", fontSize: "1.05rem" }}>
                                Studio Merapihost is a modern drag-and-drop website builder designed to help your business thrive online. No coding skills needed — simply drag elements, drop them into place, and let our AI assistant optimize your site for performance and engagement. From design to launch, everything is streamlined for speed and efficiency.
                            </Typography>
                        ...
                        <Box>
                            ...
                            <Stack spacing={1.25} sx={{ mb: 4 }}>
                                ...
                                <Typography variant="body2" sx={{ color: "text.secondary" }}>
                                    Sign in with your <b>Merapihost</b> account to continue building your website.
                                </Typography>
                            </Stack>
                            ...
                            <Stack sx={{ gap: 3 }}>
                                ...
                                <Box
                                    ...
                                    {loading.email ? "Processing..." : "Sign In"}
                                </Box>
