...
const linkedSchema = new Schema({
    ...
    _id: false // Prevents creation of an _id field for this subdocument
});

const domainSchema = new Schema({
    userId: { type: Types.ObjectId, ref: "User", required: true }, // Reference to the user who owns this domain
